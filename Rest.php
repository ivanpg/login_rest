    ...
    private function tratarEntrada() {
        ...
        switch ($metodo) {
            ...
            case "POST":
                ...
                break;
            case "DELETE"://"falling though" ejecutara el case siguiente
            case "PUT":
                //php no tiene un método propiamente dicho para leer una petición PUT por lo que se usa un "truco"
                //leer el stream de entrada file_get_contents("php://input") que transfiere un fichero a una cadena
                //Con ello obtenemos una cadena de pares clave valor de variables y por lo tanto tendremos que parsearlo.
                //Con parse_str lo meteremos en un array donde cada par de elementos es un componente del array.
